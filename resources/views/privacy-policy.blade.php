...
<div id='ppHeader'>componists.com Privacy Policy</div>
<div id='ppBody'>
  ...
  <div class='ppConsistencies'>
    <div class='col-2'>
      ...
      <div class="col-12 quick-links2 gen-text-center">Fair Information Practices
        <div class="col-8 gen-text-left gen-xs-text-center" style="font-size:12px;position:relative;left:20px;">Fair information<br> Practices</div>                </div>        </div><div class='col-2'>            <div class="col-12 quick-links2 gen-text-center coppa-pad">                    COPPA                </div>        </div><div class='col-2'>            <div class="col-12 quick-links2 quick4 gen-text-center caloppa-pad">                    CalOPPA                </div>
      </div>
      <div class='col-2'>
    ...
    <br />
    <div class='innerText'>We collect information from you when you register on our site or enter information on our site.
    </div>
    <br>
    <span id='infoUs'></span>
    <br>
    ...
    <br>
    <div class='innerText'>If you turn cookies off, It won't affect the user's experience .</div>
  ...
  <div class='innerText'>www.componists.com</div>
  <div class='innerText'>Belgium</div>
  <div class='innerText'>pioma93@hotmail.com</div>
  <div class='innerText'><br>Last Edited on 2018-06-03</div>
</div>
@endsection
