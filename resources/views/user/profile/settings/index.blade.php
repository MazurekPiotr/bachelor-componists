                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        @if(session()->has('dimensions'))
                            <div class="alert centered red white-text">
                            {!! session('dimensions') !!}
                            </div>
                        @endif
                        <form action="{{ route('user.profile.settings.update', Auth::user()->name) }}" method="post" enctype="multipart/form-data" class="row">
                            ...
                            <div class="profile-info col s12 m6">
                                <div class="row">
