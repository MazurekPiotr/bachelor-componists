...
<script>
    export default {
        ...
        methods: {
            getStatus() {
                return this.$http.get('/projects/' + this.projectSlug + '/report/status').then((response) => {
            ...
            report() {
                return this.$http.post('/componists/projects/' + this.projectSlug + '/report').then((response) => {
                    this.getStatus();
                });
            }
        },
